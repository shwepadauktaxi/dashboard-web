...
use App\Models\User;
use App\Notifications\PushNotification\CustomAnnouncement;
...
class CustomNotificationController extends Controller
{
    ...
    public function sendCustomNotification(Request $request)
    {
        ...
        $customNoti = CustomNotification::create([
            'title' => $validatedData['title'],
            'body' => $validatedData['body']
        ]);

        Notification::send(User::all(), new CustomAnnouncement($customNoti->title, $customNoti->body));
